    ...
    <div class="wrapper center-me">
        <div class="ui inverted blue tertiary segment">
            ...
            <div class="ui raised segment" id="customize-styling">
                ...
                <p>
                    You can suppress the default HTML injection altogether: <code>const instance = new Accessibility({suppressDomInjection: true});</code>. You will need to provide your own DOM and call <code>menuInterface</code> functions.
                </p>
                <p>
